...
* Sophie-Marie Ordelman, sophiemarie.ordelman@students.fhnw.ch
* Salomon Häseli, salomon.haeseli@students.fhnw.ch

Link zu Implementationshilfe: https://docs.google.com/document/d/19v2BNV63JT0GxNeXNWUSkxGXE9CN0q0TP9wstz3knZQ/edit?usp=sharing

=== Integriert in die OOP2-Projekte von

* Wissen wir nicht, da kein Feedback nach Postersession erhalten. Studenten haben unsere Dokus angeschaut, wir wissen aber nicht ob sies implementiert haben.
